...
-- WHERE 절로 PK 동등조건을 걸면 무조건 단일행이 조회된다.
SELECT
    EMP_NO, EMP_NM, ADDR, SEX_CD
FROM
    TB_EMP
...
-- 성씨가 김씨이면서, 부서가 100003, 100004, 100006번 중에 하나이면서, 90년대생인 사원의 사번, 이름, 생일, 부서코드를 조회
SELECT
